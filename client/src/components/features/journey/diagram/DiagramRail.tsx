  ...
  return (
    ...
    >
      ...
      {label ? (
        <Typography
          tag="p"
          className="relative rounded-full border border-border-focus bg-background-900 px-16 py-8 md:px-14 md:py-6 xl:px-16 xl:py-8 text-12 xl:text-14 text-text-sky"
        >
          {label}
        </Typography>
      ) : (
